...
public class TalentTree {
    ...
    private TalentTree (TalentTreeBuilder builder){
        ...
        if (List.of().equals(builder.classTree)) { Assert.notEmpty("SpecTree", builder.specTree);}
        if (List.of().equals(builder.specTree)) { Assert.notEmpty("Tree", builder.classTree); }
        this.classTree = builder.classTree;
        this.specTree = builder.specTree;

    }

    public List<Talent> getClassTree() { return classTree; }
    public List<Talent> getSpecTree() { return specTree; }
