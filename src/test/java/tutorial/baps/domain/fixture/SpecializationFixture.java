...
import tutorial.baps.domain.Specialization.SpecializationBuilder;
...
public final class SpecializationFixture {
    public static SpecializationBuilder specializationBuilder() {
